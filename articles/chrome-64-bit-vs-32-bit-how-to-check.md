...
If you are on a 32-bit operating system, you cannot run 64-bit Chrome. You would need to upgrade your OS first, and your hardware must support it (any CPU from roughly 2005 onward does).
