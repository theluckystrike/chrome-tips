...
`chrome://tracing` is a deep detailed look performance tool. It allows you to record "traces" of everything Chrome does for a few seconds, every process, every thread, and every millisecond of CPU time. This is primarily for developers trying to find the root cause of a specific performance "jank" or lag.
