...
Chrome does not currently allow you to add custom labels like "Home" or "Work" to these addresses. To help identify them quickly in a dropdown menu, many users put a distinctive identifier in the "Company" field or ensure the first line of the address is unique enough to recognize at a glance.
