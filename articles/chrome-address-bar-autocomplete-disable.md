...
I'll walk you through multiple methods to disable or reduce Chrome's address bar autocomplete, ranging from quick toggles to more comprehensive solutions.
...
4. Find the toggle labeled Autocomplete searches and URLs
5. Turn it off
...
This won't stop all suggestions, just the ones coming from Google's servers. If you want to disable autocomplete entirely, keep reading.
...
3. Make sure Browsing history is checked
4. Click Clear data
...
2. Use your arrow keys to highlight it (or hover with your mouse)
...
3. Change from "Sync everything" to Customize sync
