...
description: "Learn how Chrome AI powered search suggestions work, their benefits, privacy implications, and how to manage them. Read more to optimize your experience."
date: 2026-03-10
...
The AI component makes these suggestions different from the old-style autocomplete. Previously, Chrome would only suggest websites you had visited before or popular search terms. Now, the AI can suggest entire search queries, related topics, and even answers to questions you have not asked yet. It learns from your habits over time, so the more you use Chrome, the better it becomes at predicting what you want.
...
These suggestions also help when you are not sure exactly how to phrase what you are looking for. The AI can suggest more specific versions of your search, helping you find better results without having to refine your search manually. For example, if you type "weather", Chrome might suggest your local weather or weather for a specific city you frequently check.
...
The data sent includes your partial search terms and may also include other contextual information like your location and browsing history. Google states that this data helps improve the suggestions and is not kept indefinitely, but the idea of your keystrokes being visible to Google concerns many users who value their privacy.

Another consideration is that AI suggestions are based on your browsing patterns. The more you use Chrome, the more it knows about you. This can create a situation where the suggestions become too personalized, essentially showing you a filtered view of information based on what you have searched for before. You might miss out on different perspectives because the AI is showing you what it thinks you want to see.
...
To find these settings, click the three dots in the upper right corner of Chrome and choose Settings. On the left side, click on Privacy and security, then look for Sync and Google services. You will find an option called Autocomplete searches and URLs. Click on it to see your choices.

You can choose to keep suggestions from Google, which includes AI powered suggestions. You can also select only suggestions from your history and bookmarks, which keeps things more private but less intelligent. Or you can turn off autocomplete entirely, though this makes the address bar much less useful.
...
The good news is that Chrome does not force you to accept AI suggestions. You have meaningful choices about how much AI influence you want in your browsing. Take some time to explore the settings, try different configurations, and find what works best for your situation.
