...
When you tap that option, Chrome leverages your device's camera and motion sensors to understand your environment. The browser identifies flat surfaces like floors or tables, then places the 3D model on those surfaces. You can then interact with the object using touch gestures, moving it around or resizing it to better fit your space.
...
On Android, you need Chrome version 79 or higher and the Google Play Services for AR installed. Your device must also support ARCore. Most flagship phones from Samsung, Google, and other major manufacturers include ARCore certification.

On iOS, Safari is the primary browser supporting AR Quick Look, though Chrome on iOS can also display some AR content. iPhones and iPads with A9 chip or later processors support ARKit and can run AR experiences through mobile Chrome.
...
Online shopping has benefited significantly from web AR. Furniture retailers let you place virtual couches, tables, and decor items in your actual room before purchasing. This helps you gauge size, color, and style in a way that static images cannot match. Similarly, home improvement stores use AR to show how paint colors, flooring, or window treatments might look in your space.

Fashion and accessories brands have adopted AR for trying products virtually. You can see how eyeglasses look on your face, preview jewelry, or even visualize how a new hairstyle might appear. This reduces the uncertainty of online shopping and helps reduce returns.

Education has found creative uses for web AR as well. Museums and educational websites embed 3D artifacts that students can examine from all angles. Science visualizations become more engaging when students can manipulate molecular structures or explore anatomical models in their own space.
...
When browsing, look for the AR button on compatible webpages. This button typically appears as a small cube icon or says "View in AR" or "Place in your space." Tapping this button launches the AR experience. Follow the on-screen instructions to scan your environment and position the object.
...
If the AR button is missing, first confirm your device supports ARCore or ARKit. Then verify you are using a compatible browser version. Some websites detect device capabilities and only display the AR option when your device meets their requirements.

If the camera fails to start or shows a black screen, check that Chrome has camera permission in your device settings. Also ensure no other app is currently using the camera, as this can create conflicts.
...
For developers, web AR offers an accessible entry point to create immersive experiences without the complexity of building native apps. Tools like model-viewer make it straightforward to add AR capability to any website. As more businesses recognize the value of AR for customer engagement, the web will become increasingly enriched with augmented reality experiences.

Chrome continues to improve its AR capabilities, with regular updates bringing better performance and new features. Keeping your browser updated ensures you can take advantage of these improvements as they become available.
