...
2. Tap "Settings" and then tap your account name at the top.
3. Tap "Sync" and then toggle off "Sync."
4. For additional battery savings, consider disabling "Background sync" specifically under Chrome's advanced settings.

**For iOS:**
1. Open Chrome and tap the three-dot menu.
2. Tap "Settings" and then tap your Google account.
3. Tap "Sync" and toggle off the sync options you don't need.
