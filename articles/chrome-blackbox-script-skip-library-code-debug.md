...
Consider blackboxing patterns over specific files. Patterns are more solid because they continue to work as file names might change between builds. A pattern like `.*/vendor/.*` will always catch vendor code regardless of the specific file names.
