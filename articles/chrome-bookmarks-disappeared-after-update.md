...
I'll walk you through practical solutions to recover your bookmarks after a Chrome update, explain why this happens, and share tips to prevent it from happening again.
...
Step 4: If they don't, click the three-dot menu → Settings → Sync and Google services → Click "Manage sync" and ensure "Bookmarks" is turned on.
...
1. Click the three-dot menu → Bookmarks → Bookmark manager
