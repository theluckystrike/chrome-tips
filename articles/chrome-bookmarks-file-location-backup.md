...
description: "Find where Chrome stores your bookmarks file and learn how to back it up to prevent data loss. Simple steps for Windows and Mac users. Read more to optimize you"
date: 2026-01-15
...
There are several situations where knowing the exact file location becomes useful. If Chrome fails to start or your profile becomes corrupted, you might need to manually recover your bookmarks from the backup file. When you switch to a new computer, you can copy your bookmarks file directly instead of relying solely on sync. Some users prefer to keep a manual backup as an extra safety net, especially if they use multiple Google accounts or have experienced sync issues in the past.
...
On Windows, the default location is in your AppData folder. If you use Windows and have not moved your user data folder, look in C:\Users\YourUsername\AppData\Local\Google\Chrome\User Data\Default. The "Bookmarks" file is inside that Default folder. On Mac, the path is ~/Library/Application Support/Google/Chrome/Default/Bookmarks. You can also check by opening Chrome and typing chrome://version in the address bar, which will show you the exact path to your profile folder.

If you use multiple Chrome profiles, each one has its own folder inside the User Data directory. The default profile is called "Default," while additional profiles have names like "Profile 1" or "Profile 2." Each profile folder contains its own Bookmarks file, so make sure you are looking at the correct one.
...
To export your bookmarks, open Chrome and click the three dots in the upper right corner to access the menu. Select Settings, then look for Bookmarks in the left sidebar. Click on it, and at the bottom you will find an option to export your bookmarks. Chrome will ask you to choose a location to save the file. Pick a folder you will remember, such as a dedicated backup folder on your desktop or in your Documents directory. The exported file will look like "Bookmarks from Chrome.html" and it contains all your bookmarks organized exactly as they appear in your browser.

The second approach involves simply copying the Bookmarks file from your profile folder. Navigate to the location we discussed earlier, find the Bookmarks file, and copy it to your backup location. This method preserves everything exactly as Chrome stores it, including any metadata. The disadvantage is that you cannot easily view the contents without importing it back into Chrome.
...
If you have a local backup file, you can import it back into Chrome. Go to Settings, then Bookmarks, and look for the import option. Select your backup file, and Chrome will restore all your saved websites. This works whether you exported using the HTML method or copied the raw Bookmarks file.
