...
For other data like bookmarks and history, Google uses standard encryption in transit, but the data is stored on Google's servers in a format that Google can read. This is necessary for the sync feature to work properly, since the system needs to match your data across devices.
...
For example, if you do not want your browsing history shared across devices, you can disable history sync while keeping your bookmarks synced. This granular control means you can tailor the cloud experience to your comfort level. Some people love having everything available everywhere, while others prefer to keep certain data more private.
...
You can also choose to clear all synced data from your account if you want a fresh start. This is useful if you are selling or giving away a device and want to ensure your personal information is not still accessible through the cloud.
...
- [Chrome Magnifier Zoom for Visually Impaired](/chrome-magnifier-zoom-for-visually-impaired/)
