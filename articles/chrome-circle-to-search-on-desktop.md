...
description: Learn how to get Circle to Search functionality on your Chrome desktop
  browser. Simple methods to search anything on screen without typing. Learn how to
  opti...
date: 2026-03-09
categories:
- features
...
Second, implementing Circle to Search requires significant image recognition technology running in the background. On mobile devices, this processing happens locally or through cloud services optimized for mobile. Bringing this to desktop would require additional development work and might not perform as well without the dedicated AI hardware found in modern smartphones.
...
The simplest approach is to use Google Lens on your desktop browser. While it is not a circle gesture, you can achieve similar results by taking a screenshot of what you want to search for and uploading it to Google Lens. To do this, press the Print Screen key on Windows or Command + Shift + 4 on Mac to capture your screen. Then go to images.google.com, click the camera icon, and upload your screenshot. Google will analyze the image and show you search results.

Another option is to use the Search by Image extension for Chrome. This extension adds a button to your toolbar that lets you right-click any image on a webpage and search for it instantly. You can find it in the Chrome Web Store by searching for "Search by Image" or similar extensions. Once installed, you can right-click any picture and select the extension to perform a reverse image search.
...
One popular approach involves extensions that capture screen selections and send them to search engines. These work by letting you select an area of your screen with your mouse, similar to circling with your finger on a phone. The extension then processes the selection and returns search results in a new tab.

Extensions like Image Search Optimizer and Visual Search tools can help. They add context menu options that appear when you right-click images, allowing you to search for similar images or find product information directly. While not exactly the same as circling, these tools provide a comparable experience for desktop users.
...
Second, use high-resolution images when possible. If you are searching for products or landmarks, clearer images yield better matches. Blurry screenshots might confuse image recognition algorithms and give you irrelevant results.

Third, try multiple search methods if the first one does not work well. Google Lens works great for products and landmarks, but Bing Image Search might be better for artwork or less common items. Having a few tools in your arsenal ensures you can always find what you are looking for.
...
Chrome is already incorporating more generative AI capabilities, including enhanced search suggestions and automatic summarization. These developments suggest that gesture-based search on desktop might eventually become reality. Until then, the workarounds mentioned above should serve you well.

You can stay informed about new Chrome features by checking the official Chrome blog or enabling experimental features in Chrome flags. Sometimes enabling these flags can give you early access to features that are not yet widely available.
