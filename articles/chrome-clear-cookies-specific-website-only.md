...
permalink: /chrome-clear-cookies-specific-website-only/
---
...
1. Click the lock icon or "Not secure" text in Chrome's address bar (left of the website URL)
2. Select "Cookies" from the dropdown menu
3. In the cookies panel, you'll see a list of cookies for that specific site
4. Select individual cookies or choose "Remove all" to clear everything from that website
