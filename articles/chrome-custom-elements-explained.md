...
Custom elements are part of a broader set of web platform standards called Web Components. These standards let developers build reusable widgets and components that work smoothly across any website, regardless of what framework or tools were used to create them.
