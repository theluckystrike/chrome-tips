...
Chrome Custom Tabs represent Google's effort to make the web feel more integrated into the app ecosystem on Android. Rather than forcing users to constantly switch between apps and browsers, custom tabs allow for a more smooth browsing experience that maintains the context of what you were doing.
