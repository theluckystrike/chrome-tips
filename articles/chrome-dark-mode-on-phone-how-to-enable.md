...
description: "Learn how to enable dark mode on Chrome for phone. Simple steps to reduce eye strain and save battery with dark theme. Check out our complete 2026 guide for ..."
date: 2026-01-15
...
Another benefit is battery savings. If your smartphone has an OLED or AMOLED display, dark mode can actually help extend your battery life. This is because pixels on these types of displays do not need to light up when showing black colors, unlike traditional LCD screens. The darker your screen appears, the less energy it consumes.
...
To enable dark mode on your iPhone, go to your phone Settings app. Scroll down and tap on the Settings option.

Look for the Display and Brightness option and tap on it. You will see controls for your screen appearance.

At the top of the screen, you will see a toggle for Dark Mode. Tap on it to enable dark mode. Your entire iPhone interface will switch to dark theme, and Chrome will automatically follow this setting.
...
On Android, go back to the Theme settings in Chrome as described above and select System default. This tells Chrome to match whatever theme your Android operating system is currently using.

On iPhone, make sure the Dark Mode toggle in your iPhone settings is set the way you want it, and Chrome will automatically follow that setting.
...
First, make sure you have the latest version of Chrome installed. Google regularly updates Chrome with new features and bug fixes, and the steps for enabling dark mode might vary slightly depending on your version. Check your app store for updates if you do not see the theme option described above.

Second, check your website permissions. Some websites force their own light or dark themes, which can override Chrome's dark mode setting. You can try visiting different websites to see if the dark mode is working on some but not others.
...
You might also want to check if you have any Chrome extensions installed that might be affecting the appearance. Some extensions can override browser settings, including theme preferences.
