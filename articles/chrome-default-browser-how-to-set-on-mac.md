...
description: "Learn how to set Chrome as your default browser on Mac. Simple steps to make Chrome open links automatically in macOS. Read more to optimize your experience."
date: 2026-03-09
...
First, click the Apple menu in the top left corner of your screen and select System Settings. This opens the main settings window for your Mac. In older versions of macOS, this menu was called System Preferences, but Apple renamed it to System Settings with the release of macOS Ventura and later.

Once you are in System Settings, look for the Desktop and Dock section in the sidebar. Click on it to expand the options. You will see various settings related to how your desktop and applications behave. Look for a setting called Default Web Browser. By default, it will show Safari next to it.
...
Open Chrome on your Mac and look for the three horizontal dots in the top right corner of the window. This is the Chrome menu button. Click on it and select Settings from the dropdown menu. The Settings page will open in a new tab.

On the left side of the Settings page, you will see several categories. Look for the one labeled Default browser. Click on it to see your current default browser status. If Chrome is not already your default, you will see a button that says Make Default. Click this button, and macOS may ask for your permission to change the default browser. Confirm the change, and Chrome will become your default browser.
...
Visit google.com/chrome to download the latest version of Chrome for Mac. Make sure you are downloading the version compatible with your Mac chip, whether Intel or Apple Silicon. The website usually detects this automatically, but you can check your Mac about settings if you are unsure.
...
Some applications have their own browser settings and ignore the system default. For example, Microsoft Outlook for Mac sometimes opens links in Safari regardless of your system default. To change this, you would need to look within the application settings for a browser preference option.

Another issue can occur if you have multiple browser installations, such as both Chrome and Chrome Beta. The system might set one variant as default instead of the stable release you use most. Double-check which Chrome version is set as default and make sure it is the one you actually want to use.
