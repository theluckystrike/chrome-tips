...
description: "Learn how to set Chrome as your default browser on Windows and Mac with step-by-step instructions for each operating system. Read more to optimize your experien"
date: 2026-01-15
...
First, open Chrome if it is not already running. Click the three dots in the top right corner of the Chrome window to open the menu, and then click Settings. In the Settings page, look for the Default browser section on the left sidebar. Click on it, and you will see an option that says Make default. Click the button, and macOS may ask for your permission to switch the default browser. Confirm the change, and Chrome will become your default browser.

You can also set Chrome as default through macOS System Settings. Click the Apple icon in the top left corner of your screen and select System Settings. In macOS Ventura and later, click Desktop & Dock in the sidebar. Look for the option labeled Default web browser and click on it. Select Google Chrome from the dropdown menu. On older versions of macOS, you would click General in System Preferences and then select Chrome from the Default web browser dropdown.
...
If Windows or Mac does not let you set Chrome as default, make sure Chrome is fully up to date. Open Chrome, click the three dots in the top right corner, click Help, and then select About Google Chrome. If an update is available, it will download and install automatically. After updating, try setting Chrome as default again.

Another common issue is that certain applications may have their own browser settings and ignore your system default. For example, some email clients or messaging apps have a built-in browser that opens links. In these cases, you may need to change the settings within those specific applications to use Chrome instead.
