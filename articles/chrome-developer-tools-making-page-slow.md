...
The good news is that you can take steps to minimize this impact. we will explain why Developer Tools affects performance, which panels use the most resources, and what you can do to keep Chrome running smoothly even when you need DevTools open.
