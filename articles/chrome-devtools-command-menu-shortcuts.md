...
Testing responsive designs is smooth with the command menu. Type "device" to find commands that quickly toggle device mode, switch between different device presets, or simulate specific touch events. You can also use the command menu to capture screenshots specifically formatted for different device sizes.
