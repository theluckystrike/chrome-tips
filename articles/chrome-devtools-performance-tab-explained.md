...
Below the FPS section, you will find the CPU usage chart. This shows how much of your computer's processor was used during the recording. High CPU usage often points to heavy JavaScript execution or expensive layout calculations. The Network section displays each request made by the page, showing how long each one took to complete.
...
- [Chrome DevTools Network Throttling Guide](/chrome-devtools-network-throttling-guide/)
