---
layout: default
title: Chrome Family Link Parental Controls – A Complete Setup Guide
description: Learn how to set up and use Chrome Family Link parental controls to manage your child's browsing activity, screen time, and app usage on Chrome and Android devices.
permalink: chrome-family-link-parental-controls
categories:
- chrome
- parental-controls
- family-link
...
First, download the Family Link app on your own Android phone or iPhone. You'll find it in the Google Play Store or Apple App Store. The app will guide you through creating a supervised account for your child if they don't already have one. During setup, you'll link your account to your child's account, establishing the parent-child relationship that enables supervision.

Once the accounts are linked, you can configure Chrome-specific settings. Open the Family Link app and select your child's account. Look for the "Chrome" settings section, where you'll find options to manage browsing permissions. You can choose between allowing all sites, blocking mature content, or manually selecting which sites your child can access.
...
To set up screen time, open the Family Link app and navigate to your child's account. Select "Screen time" and choose between daily limits or specific bedtimes. For example, you might set a two-hour daily limit on weekdays and allow more time on weekends. You can also set a bedtime that locks the device until morning, ensuring your child isn't using their device late at night.
...
The activity reports are particularly useful for starting conversations with your child about their online behavior. Instead of lecturing them about spending too much time on YouTube, you can reference the actual data from the activity report. This creates a more collaborative approach to managing screen time rather than an authoritarian one.
...
You can also manage Chrome extensions and themes. Children sometimes install extensions that may not be appropriate or that could affect browser performance. By requiring approval for extensions, you maintain control over what code runs in their browser.
...
Be prepared to adjust your settings over time. What works for a nine-year-old may be too restrictive for a twelve-year-old. Family Link allows you to change permissions gradually as your child demonstrates responsibility. Regular check-ins about online experiences complement the technical controls with open communication.
