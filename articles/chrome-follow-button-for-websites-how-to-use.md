...
description: "Learn how to use the Chrome follow button feature to stay updated on your favorite websites without missing new content. Read more to optimize your experience."
date: 2026-01-15
...
To make this work like a follow feature, get into the habit of checking your bookmarks for sites that publish content you want to follow. You can organize bookmarks into folders called "Sites to Follow" or "Blogs I Read." This method is reliable because it does not depend on any external service, and your bookmarks sync across all your devices when you sign into Chrome with your Google account.
...
To use RSS feeds in Chrome, you need an RSS reader extension or an online service. Several Chrome extensions can serve as your RSS reader, allowing you to subscribe to websites and see their latest posts in one place. When you install an RSS reader extension, look for the subscription option on websites you want to follow. The extension will guide you through adding the site to your feed list.
...
To manage these notifications, click the bell or speaker icon in the address bar when you are on a site that has permission to send notifications. From there, you can see which sites can notify you and change those permissions as needed.
