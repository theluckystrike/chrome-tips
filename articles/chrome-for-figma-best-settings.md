...
description: "Optimize Chrome for smoother Figma design work. Learn settings that improve performance and reduce lag. Read more to optimize your experience. Discover essentia"
date: 2025-02-20
...
This feature works by automatically putting tabs you are not actively using to sleep. Chrome frees up the memory those tabs were using, leaving more resources available for the tab you are working in. When you return to a sleeping tab, Chrome quickly wakes it up.
...
Get in the habit of closing tabs you are not using. If you need to keep reference materials available, consider using a separate browser profile for Figma work or using Chrome's tab grouping features to organize and collapse inactive tabs.
...
Go to Chrome Settings, then System, and look for "Use hardware acceleration when available." Make sure this setting is turned on.
...
In Settings, then System, look for "Continue running background apps when Google Chrome is closed." Unless you need Chrome to stay active for notifications or other reasons, turn this off.
