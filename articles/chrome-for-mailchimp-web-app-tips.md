...
Chrome itself has shortcuts that complement your Mailchimp workflow. Ctrl Shift T reopens the last closed tab, which is handy if you accidentally close your Mailchimp tab while working on a campaign. Ctrl Tab cycles through your open tabs in order, while Ctrl 1 through Ctrl 8 let you jump directly to specific tab positions. These Chrome shortcuts work smoothly whether you are switching between Mailchimp and other tools or moving between different campaign views in separate tabs.
