...
Chrome for mendeley web importer tips are not just about saving papers but also about finding them quickly when you need them. Mendeley offers solid search and filtering capabilities that work well with the items you save through the Web Importer. You can search by title, author, year, journal, or any keyword in your notes.
