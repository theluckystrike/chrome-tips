...
Browser streaming also integrates smoothly with other Chrome features. You can easily switch between your stream and other applications, respond to chat in separate tabs, and manage your entire streaming workflow within one browser window. This level of convenience is hard to match with dedicated streaming software.
