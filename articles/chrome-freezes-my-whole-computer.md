...
2. Look for extensions you do not use every day
3. Click the toggle to disable them, or click "Remove" to delete them completely
...
3. Check "Cookies," "Cached images and files," and "Other site data"
4. Click "Clear data"
...
Tab Suspender Pro is particularly helpful if you frequently have multiple projects open or need to reference many pages while working.
...
This removes all extensions, clears custom settings, and gives you a fresh, clean Chrome. You will need to reconfigure your preferences, but many users find this completely eliminates the freezing problem.
