...
2. Toggle off all extensions by moving the switch at the top right to "off"
3. Use Chrome normally for a while
...
1. Go to Settings
2. Click on "System"
3. Make sure "Continue running background apps when Google Chrome is closed" is turned off
