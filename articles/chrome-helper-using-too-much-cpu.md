...
You'll lose any experimental features you've enabled, but this fixes helper process conflicts in 85% of cases. Bookmark any flags you want to re-enable later.
