...
Adding trusted sites in Chrome is a straightforward process that takes just a few moments. one showing sites that are allowed to access your location and another showing sites that are blocked. To add a new site to either list, use the Add button under the appropriate section.
