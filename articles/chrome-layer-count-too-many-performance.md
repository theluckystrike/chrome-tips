...
GPU usage spikes indicate the graphics processor is working harder than necessary. While some GPU usage is normal, constantly high GPU usage while browsing simple websites points to layer management issues.
...
Update your graphics drivers ensures Chrome can use hardware acceleration effectively. Outdated drivers sometimes cause layer compositing to work less efficiently, exacerbating performance problems.
