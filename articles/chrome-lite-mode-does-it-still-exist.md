...
2. Look through each extension and ask yourself: "Have I used this in the past month?"
3. Remove or disable any extensions you do not actively use
4. Consider removing extensions that run in the background or inject scripts into pages
...
3. Once installed, click the Tab Suspender Pro icon in your toolbar
4. Configure your preferences, such as how quickly tabs should suspend (I recommend setting it to 5-10 minutes of inactivity)

When a tab gets suspended, you will see a grayed-out placeholder instead of the full page. Click on it, and the page will reload instantly. This dramatically reduces Chrome's memory usage, especially if you often have many tabs open.
...
3. Select "Third-party cookies" and enable "Block third-party cookies"
4. Consider installing a lightweight ad-blocker extension like uBlock Origin
...
3. Review and adjust permissions for cameras, microphones, and JavaScript
4. For sites you do not need running in the background, set them to "Not allowed" to run in the background
...
- Turn on Memory Saver in Chrome Settings
- Remove unused extensions
- Install Tab Suspender Pro to automatically manage tabs
