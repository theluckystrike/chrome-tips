...
Once granted, the website can retrieve a list of all available fonts along with metadata such as family name, style, and weight. This information allows web applications to present font selection interfaces that include every font the user has installed, creating a smooth design experience.
