...
description: "Learn how to customize Chrome with Material You design on desktop. A simple guide to bringing Google Material You aesthetics to your browser. Check out our c..."
date: 2026-03-09
...
In the Appearance settings, you will find options for themes and colors. Chrome now offers several color themes that mimic the Material You aesthetic. Click on Color and theme to see your options. You can choose from preset color palettes or select the option that matches your system theme if you are using Windows 11 or macOS Monterey and later.
...
Extensions like Material You Installer and similar theme extensions can apply more complete Material You styling to your browser. These extensions modify various aspects of Chrome's appearance, including the tab bar, bookmarks bar, and context menus to create a more cohesive Material You experience. Keep in mind that extension-based themes may not update dynamically with your wallpaper, so you will need to manually select colors that match your preference.
...
Consider combining your Material You theme with Chrome's other customization features. For example, you can set a custom new tab page background that complements your color scheme. You can also organize your tabs using tab groups, which now feature colors that blend better with the Material You aesthetic.
...
The Material You design also creates a more unified experience if you use multiple Google products. When your Chrome browser matches the look of your Android phone or other Google apps, the transition between devices feels smoother. This consistency can be particularly helpful if you work across multiple devices throughout the day.
