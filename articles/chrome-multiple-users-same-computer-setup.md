---
layout: post
title: "Chrome Multiple Users Same Computer Setup"
description: "Learn how to set up Chrome for multiple users on one computer with separate profiles, bookmarks, and personalized settings. Read more to optimize your experienc"
date: 2026-01-15
last_modified_at: 2026-03-12
permalink: chrome-multiple-users-same-computer-setup
---



If you are looking into chrome multiple users same computer setup, you probably share a computer with family members, friends, or roommates and want everyone to have their own private browsing space. This is a common need, and Chrome has built-in tools that make it surprisingly easy to handle.
...
First, open Chrome on your computer. Look at the top right corner of the browser window where you see your profile icon. This is the small circle that shows your picture or your initial. If you have not set one up yet, it might be a generic outline or the Chrome logo.

Click on that profile icon. A menu will appear showing your current profile and an option to add a new one. Look for the button that says "Add person" or "Add profile." The exact wording depends on your version of Chrome, but it should be easy to spot.

When you click on it, Chrome will ask you to give the new profile a name. You can also choose a picture or color to help identify that profile quickly. This is especially useful if you have multiple people using the computer, as it makes it obvious which profile belongs to whom.
...
To switch profiles, click on your profile icon in the top right corner of any Chrome window. You will see a list of all the profiles on your computer, with their names and pictures. Simply click on the one you want to switch to, and Chrome will open a new window with that profile.

You can also right-click on the profile icon to see additional options, such as opening a specific profile in a new window. This can be handy if you need to switch back and forth frequently throughout the day.

If you want to rename a profile or change its picture later, click on the profile icon and look for the option to manage or edit profiles. There you can make changes to any profile on your computer, including deleting ones you no longer need.
...
To add extensions, click on the puzzle piece icon in the top right corner of Chrome. From there, you can browse the Chrome Web Store and install extensions just like you normally would. These extensions will only be available in the profile you are currently using.
