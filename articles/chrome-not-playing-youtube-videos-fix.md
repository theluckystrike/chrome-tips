...
description: "Is Chrome not playing YouTube videos? This guide covers simple solutions to get your YouTube videos working again in Chrome. Read more to optimize your experien"
date: 2026-01-15
...
To update Chrome, click the three dots in the top right corner of your browser window. Select Help, then About Google Chrome. Chrome will automatically check for updates and install them if available. After updating, restart your browser and try playing a YouTube video again.
...
To clear your cache, click the three dots and select Clear browsing data. Choose a time range, making sure to select at least the past week. Check the box next to Cached images and files, then click Clear data.
...
Try watching YouTube videos in incognito mode. Incognito mode disables all your extensions, so if videos play in incognito, an extension is likely causing the problem.
...
Click the lock icon or information icon in the address bar of the YouTube website. Look for permissions related to sound or video. Make sure the permission is set to Allow rather than Block.
...
To turn off hardware acceleration, click the three dots, go to Settings, then System, and toggle off Use hardware acceleration when available. Restart Chrome and try playing a YouTube video again.
...
To check if JavaScript is enabled, go to Settings, then Privacy and security, then Site settings. Look for JavaScript and make sure it is set to Allowed for youtube.com.
...
Try closing unnecessary tabs before watching a YouTube video. Keep only the YouTube tab and any other essential tabs open.
