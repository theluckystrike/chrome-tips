...
description: "Getting annoying notifications from just one website? Learn how to manage Read more to optimize your experience. Discover essential tips for 2026."
date: 2026-03-09
...
The notification permission request appears as a small popup at the top or bottom of your browser window, asking if you want to allow or block notifications from that site. Many users click "Allow" without thinking much about it, either because they want immediate access to the site or because they are not paying close attention. Once granted, the website can send notifications at any time, often multiple times per day.
...
Go back to the Notifications section in your Site Settings that we just looked at. At the top of the page, you will see an option that says "Sites can ask to send notifications." By default, this is set to allow sites to ask. However, you can change this to "Do not allow any site to send notifications" if you never want to receive browser notifications. Alternatively, you can set it to a custom list where you manually approve each site that is allowed to ask.
...
Another way to do this is to visit the site in question, click the lock icon or information icon in the address bar, and look for the permissions section. You can adjust what the site is allowed to do directly from there, including revoking notification permission. This is a handy shortcut if you are already on the site and want to change its permissions quickly.
...
If you are still seeing notifications after blocking a site in Chrome, try clearing your browser cache and cookies for that specific site. Sometimes this can reset any lingering permissions or connection that the site has to your browser.
