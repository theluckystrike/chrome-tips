...
description: "Annoyed by Chrome notifications? Learn why they appear and how to disable them in a few simple steps. Check out our complete 2026 guide for more details and ..."
date: 2026-03-12
...
Websites use notifications for various reasons. News sites might want to alert you to breaking stories. Online stores might notify you about sales or price drops. Some websites use notifications to keep you coming back, sending you updates about new content or messages. While some of these notifications can be useful, many websites abuse the feature by sending too many alerts or using them for marketing purposes that do not add value to your experience.
...
First, click the three dots in the upper right corner of Chrome to open the menu, then select Settings. On the left side of the settings page, click Privacy and security, and then click Site settings. Scroll down to the Permissions section and click Notifications.

You will see a list of websites that are allowed to send you notifications. To remove a website, click the three dots next to its name and select Remove or Block. You can also use the toggle switch at the top of this page to block all websites from asking for notification permission, though this is a more drastic measure.
...
Go to Settings, then Privacy and security, then Site settings, just as you did before. Under the Notifications section, toggle the switch that says "Sites can ask to send notifications" to the off position. This will prevent any website from asking for notification permission, and any existing permissions you have granted will no longer function.
...
A legitimate notification from a website will appear through Chrome is notification system, and you can usually see which site it came from by hovering over or clicking on the notification. If a notification claims to be from a site you have never visited or do not have any relationship with, it is best to ignore it and consider blocking that site.
...
It also helps to periodically review your notification settings, perhaps once a month, to remove permissions for sites you no longer use. This keeps your browser tidy and reduces the number of potential interruptions.
