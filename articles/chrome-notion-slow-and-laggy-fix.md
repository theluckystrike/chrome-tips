...
categories: [chrome, notion, performance, browser-tips]
tags: [chrome-performance, notion-slow, browser-tips, productivity]
...
You can download it from [notion.so/desktop](https://notion.so/desktop) and sign in with your existing account. The desktop app often performs better, especially for users with slower computers.
