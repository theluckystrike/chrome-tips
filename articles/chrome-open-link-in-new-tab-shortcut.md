...
Pressing the middle mouse button on a link tells Chrome to open that link in a new tab automatically. This method works on most desktop mice and trackpads that support middle clicking. You can also click and hold the left mouse button, then drag slightly downward to achieve the same result on many systems.
...
This method is quick and becomes second nature once you practice it a few times. Many people find it faster than reaching for the mouse, especially when they are reading through content and want to queue up several links for later viewing.
...
A more reliable method is to use the keyboard to select multiple links. You can hold the Ctrl key (or Command on Mac) and click on each link you want to open. Each click selects an additional link. When you have selected all the links you want, right-click on any selected link and choose "Open all in new tabs." Chrome will open all the selected links in new tabs at once.
...
If a link will not open in a new tab using your usual methods, try right-clicking and selecting the option from the context menu. This sometimes works when other methods fail. You can also try copying the link address manually and opening it in a new tab yourself.
...
You can pin tabs to keep important pages easily accessible. Right-click on any tab and choose "Pin" to shrink it down to just the favicon and keep it on the left side of your tab bar. Pinned tabs stay open across browser sessions and take up minimal space.

Tab groups let you organize related tabs together. Right-click on a tab and choose "Add to new group" or "Add to existing group." You can color-code groups and give them names to keep your browsing organized. This is especially helpful when you are working on multiple projects or research topics simultaneously.
