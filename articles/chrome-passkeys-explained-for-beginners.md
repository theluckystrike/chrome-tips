...
description: "What are Chrome passkeys and how do they work? A simple guide to understanding passkeys in Google Chrome for beginners. Read more to optimize your experience."
date: 2026-01-15
...
When you want to log in later, the website sends a challenge to your device. Your device uses your private key to sign a response, proving it has the matching key. This happens without ever sending your actual key across the internet, making it much harder for attackers to steal your credentials.
...
Second, passkeys are unique for each website. Even if someone somehow managed to create a fake version of a website you use, they could not use the passkey you created for the real site on their fake version. This protects you from phishing attacks that try to trick you into logging into fake websites that look real.
...
To create a passkey for a website that supports them, you usually start by logging in with your existing password as normal. Then look for an option in your account settings that says something like "Create a passkey" or "Add a passkey." The exact wording varies from site to site.

Chrome will then prompt you to choose which device you want to use for this passkey. If you are using Chrome on the same device where you want to create the passkey, you can select that device. You will then verify your identity using your device's screen lock, which might be a PIN, fingerprint, or face recognition.
...
To find out if a website supports passkeys, you can usually look in the account settings or security settings area. Look for options related to "passkeys," "passwordless login," or "WebAuthn." Some websites make it easy to find by showing a prompt when you log in that offers to set up a passkey.
...
On Android devices, Chrome can use your screen lock to verify it is you, making the experience quite smooth. If you use an iPhone, you can also use passkeys in Chrome through the iCloud Keychain, which syncs your passkeys across all your Apple devices.
...
If you use a passkey that is synced to your Google account or iCloud Keychain, you can still log in from another device that is signed into the same account. Your passkeys will be available there too.
