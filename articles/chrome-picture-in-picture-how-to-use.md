...
description: "Learn how to use Chrome's Picture in Picture feature to watch videos Read more to optimize your experience. Discover essential tips for 2026. Read more to optim"
date: 2025-03-14
...
First, open the video you want to watch in Chrome. This can be from YouTube, Vimeo, or any website that hosts video content. Make sure the video is playing.

Next, look for the Picture in Picture button in the video player. This button usually appears when you hover over the video. On many websites, it looks like a small rectangle with a smaller rectangle inside it. The exact icon varies depending on the website, but it is typically found in the same area as the fullscreen button.

If you do not see the button in the video player, there is another way. Right-click on the video itself. In the context menu that appears, look for an option that says "Picture in Picture" and click it.
...
Click the Picture in Picture button again inside the floating window. This will close the floating window and return the video to its original position in the webpage.
...
Following along with tutorials is a common use case. If you are learning something new and need to watch a how-to video while practicing in another application, Picture in Picture lets you keep the instructions visible without switching back and forth.

Watching live streams or longer videos while working is another popular use. You can keep a meeting, stream, or documentary playing in the corner while you focus on your actual work.

Listening to music videos or concert footage while browsing is also common. The audio continues playing even if you minimize the floating window or cover it with other content.
...
The Picture in Picture button is missing. Some websites disable the Picture in Picture feature on their video players. This is especially common with streaming services like Netflix or Hulu due to licensing restrictions. If the button is missing from the video player, try right-clicking directly on the video to see if the option appears in the context menu.

The video keeps pausing when you switch tabs. This can happen on some websites that are designed to save bandwidth. Make sure the tab with the original video stays loaded, even if it is not in the active window. Chrome should continue playing the video in the Picture in Picture window.
...
Position the window in a corner where it will not block your main work area. The bottom-right corner is a popular choice since it stays out of the way while still being visible.

Remember that the audio will continue playing even if you cover the window with other applications. Use the volume control in the floating window to adjust audio levels.
...
Premium streaming services often block Picture in Picture to protect their content. This includes Netflix, Disney+, HBO Max, and similar platforms. They want to prevent people from using the feature to get around their viewing restrictions.

Some corporate or school networks may also block Picture in Picture through their content filters.

Live streams from certain platforms may not support Picture in Picture due to technical limitations on their end.
