...
description: "Learn how to block all pop-ups in Chrome with simple settings and extensions for a cleaner, safer browsing experience."
date: 2025-03-09
categories: [tips, privacy]
tags: [pop-ups, chrome-tips, browser-settings, blocking-ads]
author: theluckystrike
---

# Chrome Pop Ups How to Block All

If you are searching for how to block all pop ups in Chrome, you have likely encountered those annoying windows that suddenly appear while you are trying to browse. Pop ups can be disruptive, they can hide malicious links, and they can make using Chrome a frustrating experience. The good news is that Chrome has built-in tools to help you block these interruptions, and there are additional steps you can take to ensure a pop-up free experience.
...
These malicious pop ups can look very convincing. They might display warning messages that look like they come from Chrome itself, or they might claim your computer is infected and need immediate attention. The goal is to scare you into clicking on something or calling a fake support number. By learning how to block all pop ups in Chrome, you protect yourself from these deceptive tactics.
...
First, open Chrome on your computer and click the three dots in the top right corner of the window. This opens the Chrome menu. From the menu, select "Settings." On the Settings page, click on "Privacy and security" in the left sidebar. In the main area, look for "Site Settings" and click on it.

Scroll down until you see "Pop-ups and redirects" and click on that option. You should see a toggle switch that says "Pop-ups and redirects." Make sure this toggle is turned on, which means it should be blue or gray depending on your system. If it is turned off, click on it to enable the pop up blocker.
...
One popular extension for blocking pop ups is called Pop Up Blocker for Chrome. This type of extension works alongside Chrome built-in blocker to catch any pop ups that might slip through. Most of these extensions are free to use and work automatically once you install them.

Another option is to use an ad blocker that also blocks pop ups. Ad blockers are extensions that stop advertisements from appearing on web pages, and many of them include pop up blocking as part of their functionality. Popular ad blockers like uBlock Origin and AdGuard are effective at blocking both traditional ads and pop up windows.

If you are looking for a solution that goes beyond just blocking pop ups, you might want to consider Tab Suspender Pro. This extension helps manage your open tabs by automatically suspending tabs that you have not used recently, which can reduce clutter and improve browser performance. Tab Suspender Pro also includes features that help prevent unwanted pop ups from disrupting your browsing.
...
If you encounter a website that keeps showing pop ups despite your blockers, you can use Chrome site settings to block all activity from that site. To do this, click on the lock icon or the three dots in the address bar when you are on the problematic site. From the menu, select "Site settings" and then change the permissions for that site to block pop ups, redirects, or other features that might be causing issues.

Another option is to simply avoid websites that are known for aggressive pop ups. If a website constantly annoys you with pop ups even after trying to block them, consider finding an alternative source for that information.
...
If you think you might have accidentally downloaded something or revealed personal information to a scammer, it is a good idea to run a security scan on your computer. Chrome has a built-in cleaning tool that you can access by going to Settings, then "Privacy and security," and selecting "Clean up computer." This tool can help detect and remove harmful software that might have been installed through a malicious pop up.
...
Review your extensions occasionally to make sure you still need all of them. Sometimes extensions can become outdated or compromised, so removing ones you do not use is a good security practice. Keep the extensions that you trust and that are actively maintained by their developers.
