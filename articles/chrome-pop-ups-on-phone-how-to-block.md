...
If Chrome's built-in tools are not enough, consider switching to a browser that has more solid blocking features built right in. Browsers like Brave, Firefox with uBlock Origin, or Kiwi Browser (which supports Chrome extensions on Android) offer stronger protection against pop-ups and ads.
