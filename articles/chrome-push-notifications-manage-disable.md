...
Open Chrome and click the three-dot menu icon in the upper-right corner of the window. Select "Settings" from the dropdown menu. In the left sidebar, click on "Privacy and security," then select "Site settings." Scroll down to the "Permissions" section and click on "Notifications."

This page displays all websites categorized by their notification permissions. You'll see three groups: "Allowed to send notifications," "Blocked from sending notifications," and "Asking default." You can manually adjust each website's status by clicking the three-dot menu next to any entry and choosing either "Allow" or "Block."
...
First, you can block notifications directly from the website itself. When you receive a notification from a site you no longer want to hear from, click the gear icon or settings option within that notification to access preferences. Look for an option to unsubscribe or block notifications from that source.
...
On Windows, click the notification when it appears and look for an option to turn off notifications from that app. On Mac, hover over the notification and click the "X" to dismiss it, or adjust notification preferences in System Settings > Notifications > Google Chrome.
