...
The Reading List integrates directly into Chrome's interface, meaning you do not need to install any extensions or third-party apps to use it. It works smoothly across desktop and mobile versions of Chrome, and thanks to Chrome's sync functionality, your Reading List travels with you wherever you go.
