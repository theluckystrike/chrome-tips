...
The Web Serial API has gained broad support across modern browsers, though implementation details may vary. Chrome was an early adopter, and its implementation remains solid for most use cases. Firefox and Safari have also added support, making it increasingly viable for cross-browser applications.
