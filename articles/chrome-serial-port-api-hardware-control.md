...
If you have ever wanted to control a microcontroller, read sensor data in real-time, or interface with industrial equipment directly from your browser, the Chrome Serial Port API provides the (bridge) you need. This guide walks you through everything you need to know to get started with serial communication in Chrome.
