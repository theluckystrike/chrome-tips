...
description: Learn what Chrome shortcuts in PWAs are and how to define them. A simple guide to adding custom shortcuts to your Progressive Web Apps. Read our comprehensive g
date: 2026-03-10
categories:
- pwa
- features
...
Chrome shortcuts in PWAs are essentially quick actions that appear when you right-click on a PWA icon on your desktop or when you long-press on the app icon on your phone. These shortcuts let you jump directly to specific features or pages within the app without having to navigate through the main interface first. For example, if you use a PWA for email, you might set up a shortcut that opens directly to your inbox or one that starts a new message.
...
Imagine you use a project management PWA for work. Every day, you need to check the tasks assigned to you, review the calendar, and send updates to your team. With custom shortcuts, you could have three different shortcuts on your desktop or phone homescreen, each opening directly to those specific sections. This eliminates the need to click through menus and wait for pages to load.

Another benefit of chrome shortcuts in pwa how to define is improved accessibility. For users who have difficulty with precise mouse clicks or touch navigation, having direct shortcuts can make a big difference. Instead of navigating through several screens, they can simply click on the shortcut that takes them exactly where they need to go.
...
When a developer creates a PWA, they can include a section in the manifest that defines various shortcuts. Each shortcut specifies a name, a URL that should open when the shortcut is clicked, and optionally an icon. These shortcuts are then registered with the browser, and they appear in the context menu when you interact with the PWA icon.

For users, the good news is that you do not need to worry about the technical side. Once a developer has added shortcut definitions to their PWA, the shortcuts automatically appear for everyone who installs the app. You will see them when you right-click the PWA on desktop or long-press on mobile.
...
Some PWAs even allow you to customize which shortcuts appear based on your usage patterns. This makes the app smarter and more helpful over time. If you frequently use a particular feature, the app might prioritize that shortcut or offer quick access through the context menu.
