...
The Benefits of Using the Side Panel
 ...
 why you should bother with the side panel when you can already do all these things through other means. The main advantage is convenience and speed. Having these features accessible without leaving your current page means less context switching and a more fluid browsing experience.
