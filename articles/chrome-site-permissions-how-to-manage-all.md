...
description: "Learn how to manage all Chrome site permissions in one place to control what websites can access. Check out our complete 2026 guide for more details and prof..."
date: 2026-03-12
...
Some permissions are necessary for websites to work the way they should. A video chat site needs your camera and microphone to function. A restaurant finder needs your location to show nearby options. A news website might want to send you alerts about important stories. These make sense.
...
Some websites use notifications as a way to push advertising to your desktop. You might find yourself distracted by pop-ups you never asked for. Other sites might want access to your location even when there is no good reason for them to know where you are. In rare cases, a website you visited once and no longer use might still be collecting data in the background because you never revoked its permissions.
...
First, open Chrome on your computer and click the three dots in the upper right corner. This opens the menu. From there, click Settings. On the left side of the Settings page, look for Privacy and security and click on it. Then, click Site Settings. This is where Chrome keeps everything related to what websites can do.

Once you are on the Site Settings page, you will see a long list of permission types. Each one shows you which websites currently have access. For example, if you click on Notifications, you will see a list of sites that are allowed to send you notifications. If you click on Location, you will see which sites can see where you are.
...
Visit the website whose permissions you want to change. Look at the left side of the address bar. You will see a lock icon or a symbol like a piece of paper. Click on it. A small window will appear showing the connection security status. Below that, you will see a section called Permissions. Click on it, and you will see a list of every permission that website currently has. You can click on each one to change it from Allow to Block, or vice versa.
...
Go back to the Site Settings page. Scroll through the list of permission types. For each one, click on it to see the full list of websites. You will see options to remove permissions one by one or sometimes clear all permissions for that category.

If you want to be thorough, go through each permission type systematically. Start with Notifications, then Location, Camera, Microphone, and so on. For each one, ask yourself whether that site really needs that access. If you have not visited the site in months or cannot remember why you granted permission, it is probably safe to remove it.
