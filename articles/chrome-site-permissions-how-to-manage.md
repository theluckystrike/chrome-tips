...
description: "A friendly guide to finding and controlling what websites can access in your Chrome browser. Check out our complete 2026 guide for more details and professio..."
date: 2026-03-12
...
Location is one of the most common permissions. Websites use this to show you content relevant to where you are, like finding nearby restaurants or showing local weather. Your camera and microphone permissions let sites use these devices for video calls, voice recording, or other interactive features. Notifications allow websites to send you alerts even when you are not visiting them directly. Cookies and site data let sites remember your login information, preferences, and shopping cart contents.
...
On your computer, open Chrome and look for the three dots in the upper right corner. Click on them to open the menu, then select Settings. On the left side of the settings page, you will see several categories. Click on Privacy and security, and then choose Site Settings. This is the main hub for everything related to what websites can do in your browser.
...
Visit the website whose permissions you want to change. Look at the left side of the address bar, near where the website URL appears. You will see either a lock icon, a warning symbol, or a small icon that looks like a piece of paper. Click on it. A small window will appear showing you the security status of your connection to that site. Below that, you will see a section called Permissions. Click on each permission to see what it is currently set to, and you can change it from Allow to Block or the other way around.
...
Go back to the Site Settings page and work through each permission category one by one. Click on Location, for example, and you will see a list of every site that has access to your location. You can remove permissions one by one, or if there is an option to clear all of them for that category, you can do that too. Repeat this for camera, microphone, notifications, cookies, and any other permissions you want to review.
