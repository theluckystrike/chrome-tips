...
description: "Is Slack running slowly in Chrome? Learn practical solutions to speed up Slack in your browser, from clearing cache to optimizing Chrome settings. Get your workspace running smoothly again."
date: 2026-01-15
...
2. Enable "Memory Saver" to automatically free up memory from inactive tabs
3. Consider using the "Custom" tab to limit the number of background processes
...
2. Customize your notification settings to reduce the frequency of updates

**Clear Slack's local cache:** Slack stores data locally that can become bloated.

1. Type `chrome://settings/cookies` in the address bar
2. Search for "slack.com"
3. Remove Slack-related cookies and cached data
4. Log back into Slack fresh
