...
If Chrome's built-in Memory Saver isn't providing enough relief, you might want to look into a more solid solution like Tab Suspender Pro. This extension is designed specifically for power users who need to keep many tabs open but are working on limited hardware. Tab Suspender Pro gives you much finer control over which tabs get suspended and after how much time. On an older MacBook, this can be a significant improvement, as it proactively keeps your RAM free before the system starts to crawl.
