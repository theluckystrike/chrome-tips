...
The Console also works smoothly with source maps. You can type expressions using your original variable names, and Chrome will evaluate them in the context of your running code. This is incredibly valuable when you need to test hypotheses about why a particular function is behaving unexpectedly.
