...
description: "Learn how to set multiple startup pages in Chrome to open several favorite websites every time you launch the browser. Check out our complete 2026 guide for ..."
date: 2026-03-12
...
Beyond just saving time, having your most-used sites ready to go means you can start working immediately rather than navigating through your bookmarks or typing in URLs. It also helps if you tend to forget to open certain sites and then wish you had them available later. By setting them as startup pages, you never have to think about it.
...
First, open Chrome on your computer. Click the three dots in the upper right corner of the window to open the menu. From the menu, choose Settings. This opens a new tab with all of Chrome's settings organized by category.

On the left side of the Settings page, find and click the section called On startup. This is where Chrome controls what happens when you first open the browser. You will see several options displayed on the right side of the screen.

Look for the option labeled Open a specific page or pages and click on it. You may see it already selected or you may need to select it yourself. Once you click it, a text field appears where you can enter a website address.

In the text field, type the full URL of the first website you want to open at startup. Make sure you include the https:// part, though Chrome often fills this in automatically. For example, you might enter https://gmail.com or https://calendar.google.com.

Now comes the part for adding multiple pages. Look for a link or button that says Add a new page. Click it, and another text field appears. Enter the URL of your second startup page. You can repeat this process for as many pages as you want. Each one will open in its own tab when Chrome launches.
...
It is also worth considering how many tabs you are comfortable having open at once. While Chrome can easily handle several startup tabs, opening too many can slow down your initial launch, especially if those pages are heavy with content like videos or interactive elements. Five or fewer startup pages is usually a good balance between convenience and performance.
...
First, make sure you actually selected the Open a specific page or pages option. If Continue where you left off is selected instead, Chrome will ignore your specific pages and restore whatever tabs you had open previously. Go back to the On startup section and verify that your chosen option is active.

Another thing to check is whether your startup pages have been added correctly. Sometimes a typo in a URL can prevent a page from loading. Open the On startup settings again and verify that each URL is spelled correctly and complete.
...
You might also find that having multiple tabs open at startup leads to more tabs accumulating throughout your browsing session. If Chrome starts feeling slower over time, consider using an extension like Tab Suspender Pro to automatically suspend tabs you are not currently using. This keeps your browser responsive without losing your place in tabs you want to keep open.
