...
Wait a few minutes. If the site is experiencing high traffic or temporary server issues, the problem might resolve itself. Give it five or ten minutes, then try again. This is especially true for smaller websites that might not have solid infrastructure to handle traffic spikes.
