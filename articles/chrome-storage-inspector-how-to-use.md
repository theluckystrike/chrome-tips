...
description: "Learn how to use Chrome's Storage Inspector to view, manage, and clear website storage. Simple steps for regular users. Read more to optimize your experience."
date: 2025-02-19
...
Sometimes this storage causes problems. A website might not work correctly because its stored data got corrupted. You might want to see what information a website has saved about you. Or you might be trying to free up space because Chrome is running slowly. The Storage Inspector helps with all of these situations.
...
Another reason is privacy. You might want to see exactly what a website has saved about you. The Storage Inspector shows you the actual data, not just the fact that something is stored. This can help you decide whether to clear that data or stop using a particular website.
...
Right-click anywhere on the page. A menu will appear with several options. Look near the bottom of this menu and click on Inspect. This opens Chrome DevTools, which is a window that shows how the website works behind the scenes.

Once DevTools is open, look at the tabs along the top. You will see tabs like Elements, Console, and Network. Click on the tab labeled Application. If you do not see it immediately, look for a double arrow icon that lets you see more tabs.
...
For example, you might see a name like theme with a value like dark. This means the website has saved your preference for a dark theme. Or you might see session with a long string of random characters, which might be your login information.

IndexedDB shows more complex data. This is a database system that some websites use for storing larger amounts of information. You can expand the databases to see what data they contain. This might include lists of items, user profiles, or other structured information.
...
To clear all storage for a website, look for the clear site data option. In the Storage section, right-click on the website entry and choose Clear. This removes all local storage, session storage, and cached data for that website. Be aware that this might log you out of the website or reset your preferences.
...
If you are concerned about privacy, periodically check what storage different websites have accumulated. You might be surprised how much data some websites keep. Consider clearing storage for websites you no longer use.
