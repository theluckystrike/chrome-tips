...
description: 'Discover why Chrome tabs from other devices are not showing up and learn simple steps to fix the sync issue quickly. Read our comprehensive guide to learn more '
date: 2025-03-13
categories:
- productivity
- tips
...
Another common cause is using different Google accounts on different devices. If your phone is signed into your personal Gmail account and your computer is using your work Gmail, the tabs will never sync between them because they are tied to separate accounts. This happens more often than you might think, especially when people use Chrome for both personal and work tasks.

Sometimes the sync is actually working, but the tabs are hidden in a place you have not looked yet. Chrome does display your synced tabs, but they are not visible on the main tab bar. You need to know where to find them in the browser interface.
...
Once sync is enabled, click on it to see what specific data is being synced. You need to make sure that "Open tabs" is checked or enabled. If it is not, your tabs will not appear on other devices even though other data like bookmarks might be syncing fine.
...
Go to each device and look at the profile icon in Chrome. It should show the same account name and picture. If you see different accounts, you need to sign out and sign back in with the correct account on each device. Click on the profile icon, select the account you are currently using, and choose "Sign out" if needed. Then sign in with the account you want to use across all your devices.
...
On desktop Chrome, click the dropdown arrow next to your tab count in the top right corner. This opens the tab switcher view, and at the bottom you will see a section called "Devices" or "Tabs from other devices." Click on that section to expand it and see all the tabs currently open on your other devices.

On the new tab page, scroll down and look for a section showing your recently closed tabs and tabs from other devices. This is another convenient place to access your synced tabs.
...
Second, check if sync is paused. Sometimes users accidentally pause sync, particularly when trying to save data or battery life. Go back to your sync settings and confirm that everything is active and working.

Third, if you are using Chrome on a managed computer at work or school, your administrator might have disabled sync entirely. In that case, you will not be able to sync tabs across devices unless the settings are changed by your IT department.
...
Developing good habits around tab management can also help. Try organizing tabs into groups using Chrome's built-in feature, and consider using bookmarks for things you want to keep long-term. These groups and bookmarks will sync across your devices along with your open tabs.
