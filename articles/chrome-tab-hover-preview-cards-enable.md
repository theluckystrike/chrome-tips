...
## Using Chrome's Native Tab Search
...
- **Preview delay**: Set how long you must hover before the preview appears, preventing accidental popups when moving your mouse across the tab bar
- **Preview size**: Choose how large the thumbnail appears on screen
- **Which tabs to preview**: Some extensions let you exclude certain tabs or sites from generating previews
- **Keyboard shortcuts**: Many extensions add shortcuts for quickly cycling through tab previews
...
- Make sure the extension is enabled in your Chrome toolbar
- Check that the extension has the necessary permissions
- Try disabling other tab-related extensions to check for conflicts
- Update Chrome and your extensions to the latest versions
- Restart Chrome if previews stop appearing suddenly
