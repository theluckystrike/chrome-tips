...
description: "Learn how to view and access Chrome tabs synced from your other devices using built-in features and simple settings. Read more to optimize your experience."
date: 2025-03-13
...
Another reason tabs might not appear is that you are using different Google accounts on different devices. If your phone is signed into your personal Gmail and your computer is signed into a work account, the tabs will not sync between them because they are tied to separate accounts. This is a frequent source of confusion, especially when people use Chrome for both personal and work things on the same device.
...
Once signed in, you need to turn on sync. Click on your profile icon again and look for the "Turn on sync" button or navigate to Settings and find the Sync section. Make sure the toggle for "Sync" is turned on. You can click on it to choose what specific data gets synced, but for tabs to appear across devices, you need at least the "Open tabs" option enabled.
...
On desktop Chrome, click the dropdown arrow next to your tab count in the top right corner of the browser window. This opens the tab switcher view, and at the bottom you will see a section called "Devices" or "Tabs from other devices." Click on that section to expand it and see all the tabs currently open on your other signed-in devices. You can click any of them to open that page instantly.

If you are using Chrome on Android, tap the three-dot menu and look for "Tabs from other devices" near the bottom of the menu. On iOS, tap the tabs button to enter tab overview mode, and you should see a similar option to view tabs from your other devices.
...
Second, check that sync is not paused. Sometimes users accidentally pause sync, especially when trying to save data or battery life. Go back to your sync settings and confirm that everything is turned on and working.

Third, if you are using Chrome on a managed computer, such as a work or school device, your administrator might have disabled sync. In that case, you will not be able to sync tabs across devices unless the settings are changed by your administrator.
...
If you find yourself frequently losing track of tabs across devices, developing a habit of organizing tabs into groups or using bookmarks for things you want to save long-term can also help. The built-in tab groups feature in Chrome lets you organize related tabs together, and these groups can sync across devices as well.
