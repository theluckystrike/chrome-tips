...
2. Press F7 on your keyboard (or Fn + F7 on some laptops)
3. A confirmation dialog will appear asking "Turn on caret browsing?"
4. Click OK or press Enter to enable it
...
4. Toggle on "Navigate pages with a text cursor"
