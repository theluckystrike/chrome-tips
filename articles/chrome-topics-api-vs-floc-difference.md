...
Chrome monitors the websites you visit and identifies broad topics that interest you, such as "Fitness," "Technology," or "Travel." Each week, Chrome calculates up to five topics from your recent browsing activity. When you visit a website that uses the Topics API, the site (or its advertising partners) can access these topics to show relevant ads.
