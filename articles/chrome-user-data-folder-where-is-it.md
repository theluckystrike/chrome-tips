...
description: "Find where Chrome stores your profile data including bookmarks, history, Check out our complete 2026 guide for more details and professional advice on managi..."
date: 2026-03-09
...
If you use multiple Chrome profiles, each profile has its own separate folder. This is why you can have one profile for work and another for personal browsing, and they keep different bookmarks and history. Each profile acts like a completely separate browser installation, even though they share the same Chrome program on your computer.
...
To find this folder, you can simply type the path into the address bar of any folder window. Replace "YourName" with your actual Windows username. For example, if your computer name is John, you would look for C:\Users\John\AppData\Local\Google\Chrome\User Data\Default.

If you want to browse there manually, you will need to show hidden files first. Open any folder window, click the View tab at the top, and check the box that says "Hidden items." This makes the AppData folder visible. Once you can see it, navigate through the folders until you reach the Chrome user data folder.
...
The easiest way to reach this folder is to click the Go menu in Finder while holding down the Option key on your keyboard. This reveals the Library folder in the menu. Click Library, then open Application Support, then Google, then Chrome, and finally Default. That is where your Chrome user data lives.
...
To find it, you can use your file browser to navigate to your home folder, then look for the .config folder. You may need to press Ctrl+H to show hidden files and folders. Once you find the .config folder, open it and look for google-chrome, then the Default folder inside it.
...
There is also a Cache folder that stores parts of websites so they load faster. Extensions you installed have their own folders in here too. If you ever need to clear your browser cache or reset Chrome, these are the files that get affected.
...
Some users also like to back up their user data folder periodically. This creates a copy of all your bookmarks, passwords, and settings that you can restore if something goes wrong. It is a simple way to protect your browser data, though Chrome also offers built-in sync features that automatically save your data to your Google account.
...
For those who keep many tabs open and worry about memory usage, extensions like Tab Suspender Pro can help automatically pause tabs you are not using. This reduces the strain on Chrome and keeps your browser running smoothly without you having to manually manage your open tabs.

If you want to take more control over your browser data, finding the user data folder is the first step. From there, you can back up important files, clear specific types of data, or transfer your settings to another computer. It gives you flexibility that the regular Chrome settings do not offer.
