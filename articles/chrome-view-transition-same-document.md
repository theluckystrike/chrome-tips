---
layout: post
title: "Chrome View Transition API: Smooth Same-Document Animations"
description: Create stunning, app-like animations within a single page using Chrome's View Transition API. Learn how to implement smooth state changes with minimal code.
date: '2026-01-15'
