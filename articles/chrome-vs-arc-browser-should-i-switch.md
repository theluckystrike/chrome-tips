...
This is where Chrome still dominates. Chrome Web Store has thousands of extensions, and almost every web tool you can think of has a Chrome extension. Arc supports Chrome extensions, so you can install most of the extensions you already use. However, the experience is not always smooth. Some extensions do not work perfectly in Arc, particularly those that rely heavily on Chrome-specific APIs.
