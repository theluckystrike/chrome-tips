...
description: "Discover built-in Chrome features that identify websites without extensions. Learn how to check what technology any site uses. Read more to optimize your experi"
date: 2026-03-09
...
To access this, right-click anywhere on a webpage and choose Inspect. Then click on the Network tab and refresh the page. You will see a long list of files loading in the background. Many of these have names that reveal what tools the site uses. For example, if you see files starting with "gtm-" then the site uses Google Tag Manager. Files containing "analytics" or "ga.js" suggest Google Analytics. You can look through this list to piece together what technologies power the site.
...
WordPress sites often have "wp-content" or "wp-includes" in their URLs. Shopify stores have "/products/" in their URLs and often show Shopify-related cookies. Squarespace sites have distinct patterns in their URLs and often load specific Squarespace scripts. Wix sites typically have "wixstatic.com" in their asset URLs.

For analytics and marketing tools, look for common patterns. Google Analytics usually loads a script containing "google-analytics.com". Facebook Pixel loads something with "connect.facebook.net". Hotjar, a popular session recording tool, loads scripts from "hotjar.com".
...
The next time you wonder what technology powers a website, try opening Developer Tools and exploring the Network tab or page source first. You might be surprised at how much you can discover without adding anything new to your browser.
