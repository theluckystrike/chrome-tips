...
description: "Understand Chrome web storage limits, how they work, and what you can do when you hit them. Simple guide for everyday users. Read more to optimize your experien"
date: 2026-01-15
...
The most common types of storage you will encounter are cookies, local storage, session storage, and IndexedDB. Cookies are the oldest form of web storage and are typically used for small pieces of data like whether you are logged in or what items you have in your cart. Local storage and session storage can hold larger amounts of text-based data and are commonly used to remember your preferences on specific websites. IndexedDB is a more powerful storage system that can handle complex data and larger files, often used by web applications like online document editors.
...
Within this overall limit, individual storage types have their own restrictions. Cookies are limited to about 4 kilobytes each, and a single domain can store up to 180 cookies. Local storage typically allows around 5 to 10 megabytes per origin, which is usually one website. IndexedDB has a much higher limit and can store significantly more data, which is why web apps that work with large amounts of information tend to use it.
...
For a more targeted approach, you can clear storage for specific websites rather than everything. In Chrome settings under Site settings, you can see which websites are using the most storage and remove data for individual sites. This is useful if you know that a particular website is taking up more space than it should.
