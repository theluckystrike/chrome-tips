...
description: "Learn how to install Linux apps on your Chromebook with this simple guide. Unlock more software options on your device. Read our comprehensive guide to learn..."
date: "2026-01-15"
...
Most Chromebooks released after 2019 support Linux apps. This includes many popular models from various manufacturers. To check if your device supports Linux apps, click on the clock in the bottom right corner of your screen, then click on the gear icon to open Settings.

In the Settings window, look for an option called "Linux" or "Linux (Beta)" in the left sidebar. If you see it, your Chromebook can run Linux apps. If you do not see this option, your device may not support this feature, or you might need to enable it through a different menu.
...
From the Settings menu, click on "Linux" or "Linux (Beta)" in the sidebar. You should see a button that says "Turn on" or something similar. Click this button to start the setup process.

Your Chromebook will ask you how much disk space you want to allocate for Linux apps. The default amount is usually sufficient for most users, but if you plan to install many programs or large applications, you might want to allocate more space. You can choose anywhere from a few gigabytes to several hundred gigabytes.

After you select the amount of space, click "Install" to begin the installation process. Your Chromebook will download and set up the Linux environment. This might take several minutes depending on your internet connection and the speed of your device.
...
Most Linux distributions use a package manager called APT. To install an app, you typically use the command "sudo apt install" followed by the name of the program you want to install. For example, to install GIMP, you would type "sudo apt install gimp" and press Enter.

Before installing any app, it is a good idea to update your package lists. You can do this by typing "sudo apt update" and pressing Enter. This ensures that you get the latest versions of the software available.

When you type a command to install an app, the system will ask for confirmation. Simply type "y" and press Enter to confirm. The download and installation will begin automatically.
...
For productivity, you might consider LibreOffice, which is a full office suite similar to Microsoft Office. It includes a word processor, spreadsheet program, presentation software, and more. Another option is OnlyOffice, which has a slightly different interface but offers similar functionality.

If you need image editing, GIMP is a powerful option that can replace Adobe Photoshop for many tasks. For video editing, consider Kdenlive or Olive, though keep in mind that video editing can be demanding on older Chromebooks.

For media playback, VLC is an excellent choice that can play almost any video or audio format. It is known for its broad compatibility and useful features.
...
If you want to remove an app, you can use the command "sudo apt remove" followed by the app name. This frees up space on your Chromebook.
...
First, be patient with the terminal at first. It might look intimidating, but you only need to learn a few simple commands to manage your apps effectively. There are plenty of online resources that can help you learn more as you become comfortable.

Second, remember that Linux apps run in a separate environment from your Chrome apps. This means they will not appear in your Chrome browser, but they will show up in your app launcher alongside your other applications.

Third, if you encounter any issues, try restarting your Linux environment. You can do this by right-clicking on the terminal icon in your app launcher and looking for a restart option.
