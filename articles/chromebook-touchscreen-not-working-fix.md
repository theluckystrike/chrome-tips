...
To restart your Chromebook, click on the time in the bottom right corner of your screen, then click the power button icon, and select Restart. Wait for your device to fully shut down and turn back on. Once it has restarted, test your touchscreen to see if it is working again.
...
To check this, click on the time in the bottom right, then click on the gear icon to open Settings. In the search box at the top of the Settings page, type touchscreen. Look for a result that says Enable or Disable Touchscreen and make sure it is turned on. If it was already on, try turning it off, waiting a moment, and turning it back on again.
...
To check for updates, click on the time in the bottom right, click on the gear icon to open Settings, and look for the option that says About Chrome OS. Click on Check for Updates. If an update is available, let your Chromebook download and install it, then restart when prompted.
...
To perform a Powerwash, go to Settings, click on Advanced in the left sidebar, and scroll down to the bottom. You will see an option that says Powerwash. Click on it and follow the prompts. Your Chromebook will restart and return to its original state.
...
To find this option, open Settings and search for calibration or touchscreen. Look for a calibration tool in the results. Not all Chromebooks have this option, so if you do not see it, your device might not support it.
...
Physical damage can cause the touchscreen to stop working, and in these cases, you might need professional repair. Inspect your screen for cracks, scratches, or any signs of damage. Check around the edges of the screen as well.
...
You can also take your Chromebook to a local repair shop that specializes in Chrome OS devices. They can diagnose the problem and let you know what options you have.

Remember that touchscreen issues are common and often fixable. Do not give up hope if the first few solutions do not work. Keep trying the different methods listed here, and you have a good chance of getting your touchscreen working again.
