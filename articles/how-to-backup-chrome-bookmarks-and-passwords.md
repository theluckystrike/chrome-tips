...
description: "Learn how to backup Chrome bookmarks and passwords to keep your data safe. Simple step-by-step guide for Windows and Mac users. Read more to optimize your exper"
date: 2026-01-15
...
If Chrome crashes unexpectedly or your browser profile becomes corrupted, you could lose access to your saved data. Sometimes updates cause conflicts that reset your settings or delete stored information. On rare occasions, users have reported losing bookmarks after clearing cache or performing certain maintenance tasks. Having a separate backup means you can recover your data instantly, regardless of what happens to your browser.
...
On Windows, you will find this folder in your AppData folder. On Mac, it lives inside your Library folder. Chrome also stores other data there, including your browsing history, cookies, and extensions. Knowing this helps you understand that your bookmarks and passwords are not just floating somewhere in the browser interface, they are actual files on your computer that can be copied and saved.
...
To start, open Chrome on your computer and look for the three dots in the upper right corner of the window. Click on them to open the menu, then select Settings. On the settings page, look for the section called Bookmarks on the left sidebar. Click on it, and you will see options for managing your bookmarks.

At the bottom of the bookmarks section, you will find a link that says "Import bookmarks." Click the arrow next to it to reveal more options, and you should see an option to export your bookmarks. Chrome will ask you where you want to save the file. Choose a location that you will remember, such as a dedicated backup folder on your desktop or in your Documents folder.
...
Open Chrome and click the three dots in the upper right corner, then select Settings. On the left sidebar, find and click on Autofill, then select Passwords. Alternatively, you can type chrome://settings/passwords in your address bar and press Enter to go directly there.

On the passwords page, look for the three-dot menu button next to the "Saved Passwords" heading. Click on it, and you will see an option that says "Export passwords." Chrome will ask you to confirm your identity before proceeding, usually by asking for your computer password or requiring you to sign in to your Google account again.
...
Do not email the file to yourself or leave it in a shared folder. Do not keep it on your desktop where guests or family members might accidentally open it. Once you have imported the passwords into your new browser or password manager, delete the export file from your computer. Some users prefer to create the backup right before they need it and delete it immediately after, keeping it off their computer as much as possible.
...
Go back to the Bookmarks section in Chrome settings. Click the arrow next to "Import bookmarks" and select "Import bookmarks." A file browser will open, allowing you to select the HTML file you saved earlier. Choose the file, and Chrome will import all your bookmarks in their original folder structure. You will find them in the same order they were before.
...
If you often find yourself with dozens of open tabs, consider using tools that help you organize them better. Tab Suspender Pro is one option that can automatically suspend tabs you are not using, freeing up memory and making your browser run faster. It also gives you a clearer view of what is open, helping you stay focused and productive.
