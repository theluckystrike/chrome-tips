...
description: "Learn how to stop unwanted Chrome notifications on your Android phone with simple steps. Read more to optimize your experience. Discover essential tips for 2026"
date: 2026-01-15
...
The notifications you receive can range from useful updates to completely irrelevant spam. Some websites send notifications about new content, price drops, or messages. Others abuse the feature by sending promotional messages, clickbait headlines, or reminders designed to get you to return to their site. Even worse, some websites sell your notification permission to third parties, meaning you start receiving notifications from companies you have never heard of and never gave permission to.

Another issue is battery life. Each notification causes your phone to light up, vibrate, and process data. If you have notifications enabled for dozens of websites, this can have a noticeable impact on how long your battery lasts between charges. The constant interruptions also break your focus and make it harder to concentrate on tasks that matter.
...
Open Chrome on your phone and tap the three dots in the upper right corner of the screen. This opens the Chrome menu. From the menu, select Settings. Scroll down until you see the Permissions section and tap on it. Look for the Notifications option and tap on it.

You will see a toggle switch labeled "Notifications" or "Site notifications" depending on your version of Chrome. Turn this toggle off to disable all website notifications entirely. This is the most complete solution if you never want to receive notifications from any website.
...
Go to the website you want to block in Chrome. Look at the address bar at the top of the screen. If that website has permission to send you notifications, you will see a bell icon on the right side of the address bar. The bell may be filled in or have a small dot next to it to indicate that notifications are active.

Tap on the bell icon. A small menu will appear showing the current notification status for that site. Tap on Block or Turn off to revoke the website is permission to send you notifications. You should see a confirmation that the permission has been removed.
...
Open the Settings app on your Android phone. Look for Apps or Applications, then find Chrome in the list of installed apps. Tap on Chrome and look for Notifications. From here, you can see all the categories of notifications that Chrome can send and turn them off individually or entirely.
...
In Chrome, go to Settings, then Permissions, then Notifications. You should see a list of websites that currently have permission to send you notifications. Tap on each site to see the options available, then remove the ones you no longer want.
...
Some browser extensions can help manage notifications more effectively, though these work primarily on desktop browsers. For Android, using Chrome built-in controls is the most straightforward approach.
