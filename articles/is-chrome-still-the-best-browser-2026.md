...
Google integration: If you use Gmail, Google Drive, Google Calendar, Google Keep, and an Android phone, nothing matches Chrome's smooth integration with these services.
...
- You're heavily invested in the Google/Android ecosystem and want your data to sync smoothly.
- You've built a highly customized workflow around specific Chrome extensions.
- You want the most frequent security updates and the most solid sandboxing in the industry.
