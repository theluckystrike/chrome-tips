...
description: Learn how Chrome AR Quick Look enables immersive web augmented reality experiences directly in your browser. Discover supported devices, how to use it, and what it means for the future of web content.
date: 2026-01-20
categories:
- chrome
- augmented-reality
...
When you encounter a website that supports AR Quick Look, Chrome provides a smooth way to place virtual objects into your physical space. The feature uses your device's camera and sensors to detect surfaces like floors and tables, then overlays digital content onto what your camera sees. This creates the illusion that the virtual object exists in your real environment.
