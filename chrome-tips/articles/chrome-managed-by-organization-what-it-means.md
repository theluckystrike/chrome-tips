...
The most common cause is residual policy settings from a previous employer. If you ever used your personal computer for work or participated in a bring-your-own-device program, your workplace might have installed management software or applied policies that remain even after you left the organization. These settings can persist even after you disconnect from the company network or remove your work account.
